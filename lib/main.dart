...
// -----------------------------------------------------------------------
// DESIGN TOKENS
// A small, deliberate palette instead of default Material colors —
// ink for text, slate for secondary text, a single teal accent for
// interactive elements, and a warm neutral background. Borders are used
// in place of drop shadows throughout for a flatter, editorial feel.
// -----------------------------------------------------------------------
class AppColors {
  static const ink = Color(0xFF1B2430);
  static const slate = Color(0xFF5B6472);
  static const accent = Color(0xFF2F6F6B);
  static const background = Color(0xFFF6F5F1);
  static const surface = Color(0xFFFFFFFF);
  static const border = Color(0xFFDDDFE0);
}
...
class PortfolioApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Yarlagadda Mahathi — Portfolio',
...
/// A minimal text-style link used for LinkedIn / GitHub — no button chrome,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Padding(
                            ...
                            child: Text(
                              'I build responsive web interfaces and '
                                  'computer vision systems, with a focus on '
                                  'clean structure and practical real-world use.',
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                fontSize: 15,
                                color: AppColors.ink,
                  ...
                  children: [
                    ...
                    const Text(
                      'I am a Computer Science Engineering student at CR RAO '
                          'AIMSCS (2024 – 2028). My work spans responsive web '
                          'interfaces and applied computer vision, and I care about '
                          'clean structure, readable code, and building things that '
                          'hold up outside a demo.',
                      style: TextStyle(fontSize: 15.5, color: AppColors.ink, height: 1.6),
                    ),
                    const SizedBox(height: 12),
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const [
                        Icon(Icons.school_outlined, size: 20, color: AppColors.accent),
                        SizedBox(width: 10),
                        Expanded(
                          child: Text(
                            'CR RAO AIMSCS — B.Tech, Computer Science Engineering '
                                '(2024 – 2028)',
                            style: TextStyle(fontSize: 14.5, color: AppColors.slate, height: 1.4),
                          ),
                        ),
                      ],
                    ),
                    ...
                    Wrap(
                      ...
                      children: const [
                        ...
                        _SkillTag(label: 'Computer Vision (OpenCV, MediaPipe)'),
                    ...
                    Wrap(
                      ...
                      children: const [
                        _ProfileLink(
                          ...
                          label: 'LinkedIn',
                          url: 'https://www.linkedin.com/in/mahathi-y-7711a6385',
                        ),
                        _ProfileLink(
                          icon: Icons.code,
                          label: 'GitHub',
                          url: 'https://github.com/Yarlagadda-Mahathi',
                        ),
                      ],
                    ),
...
class ProjectsPage extends StatelessWidget {
  ...
  static const List<Project> _projects = [
    Project(
      title: 'UniHive — College Website Frontend',
      description:
      'A responsive college website frontend unifying an e-library, '
          'student marketplace, clubs, and events into one dashboard, with '
          'smart/voice search and dark mode.',
      techStack: 'HTML · CSS · JavaScript',
      icon: Icons.language,
    ),
    Project(
      title: 'InsightFlow — Human Activity Recognition',
      description:
      'A computer vision system classifying 15 human activities from '
          'images and video using a fine-tuned MobileNetV2 model with '
          'Grad-CAM explainability, reaching 93.26% validation accuracy.',
      techStack: 'Python · TensorFlow · MobileNetV2 · Grad-CAM',
      icon: Icons.visibility_outlined,
    ),
    Project(
      title: 'DriveSafe AI — Driver Drowsiness Detection',
      description:
      'A real-time driver monitoring system that tracks eye closure, '
          'yawning, and head pose to compute a live risk score, with '
          'instant alerts and a Streamlit analytics dashboard.',
      techStack: 'Python · OpenCV · MediaPipe · Streamlit · SQLite',
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        // Two-column layout sized to each card's own content
                        // (no fixed aspect ratio, so no leftover empty space).
